...
// FIXME: This should probably only exist inside ido implementation?
// Make all functions return resolved index->id
// FIXME: Internal to ido:
...
// FIXME: index of next print should be retrieved using fpc_get-print_count internally in ido impl.
...
// FIXME: This should be internal to ido implementation
...
// FIXME: length should be fetched internally in ido implementation
